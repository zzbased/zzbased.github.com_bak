...
12年年底的时候，[老师木](http://weibo.com/p/1005051991303247)在微博上发表了很多关于机器学习领域的言论，当时，在我个人读来，有些言论是很有学习价值的。今天重新回顾了一遍，把一些有启发的点记录下来。完整言论请参考老师木的微博原文。[52cs整理的老师木言论集合](http://www.52cs.org/?cat=26)
...
无结构预测能力的模型->structured output prediction。lr变成crf，svm变成m3n。
